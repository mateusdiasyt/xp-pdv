...
import { Copy, CreditCard, ExternalLink, Loader2, X } from "lucide-react";
        ...
        <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/78 px-4 py-6 backdrop-blur-sm">
          <div className="w-full max-w-2xl rounded-3xl border border-border bg-card p-5 shadow-[0_40px_140px_-70px_rgba(0,0,0,0.95)]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {generatedUrl ? (
                <div className="space-y-3 rounded-2xl border border-emerald-400/30 bg-emerald-400/10 p-3 text-sm text-emerald-100">
                  <p className="font-semibold">Link criado. Copie para enviar ao cliente.</p>
                  <input
                    value={generatedUrl}
                    readOnly
