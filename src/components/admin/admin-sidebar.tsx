...
export function AdminSidebar({ roleSlug, permissions }: AdminSidebarProps) {
  ...
  return (
    <aside className="sticky top-0 z-30 flex h-screen w-[5.25rem] shrink-0 flex-col border-r border-sidebar-border/45 bg-sidebar/58 text-sidebar-foreground shadow-[22px_0_70px_-48px_rgba(0,0,0,0.9)] backdrop-blur-2xl supports-[backdrop-filter]:bg-sidebar/46">
      ...
      <nav className="flex-1 space-y-2 overflow-y-auto overflow-x-visible px-3 py-4">
        {items.map((item) => {
