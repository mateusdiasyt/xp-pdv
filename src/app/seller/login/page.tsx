...
import { SellerLoginForm } from "@/components/platform/seller-login-form";
import { getCurrentPlatformSeller } from "@/application/platform/seller-service";
      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-5xl items-center justify-center">
        <section className="grid w-full overflow-hidden rounded-3xl border border-white/10 bg-white/[0.035] shadow-[0_44px_160px_-86px_rgba(0,0,0,0.95)] lg:grid-cols-[0.9fr,1.1fr]">
          <div className="hidden border-r border-white/10 bg-[linear-gradient(145deg,rgba(255,0,89,0.14),rgba(255,255,255,0.035)_42%,rgba(0,0,0,0.18))] p-8 lg:block">
            ...
            <div className="mt-16">
              <p className="text-xs font-black uppercase tracking-[0.22em] text-primary">Vendedores</p>
              <h1 className="mt-4 text-4xl font-black leading-tight tracking-tight">
                Links de pagamento com comissao rastreada.
              </h1>
              <p className="mt-4 max-w-md text-sm leading-6 text-white/62">
                Gere cobrancas do Mendoza PDV e acompanhe vendas confirmadas em um painel simples.
              </p>
            </div>
          </div>
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="mb-6">
              <p className="text-xs font-black uppercase tracking-[0.2em] text-primary">Painel do vendedor</p>
              <h2 className="mt-2 text-3xl font-black tracking-tight">Entrar</h2>
              <p className="mt-2 text-sm leading-6 text-white/58">
                Acesso limitado para gerar links e acompanhar suas vendas.
              </p>
            </div>
            <SellerLoginForm />
          </div>
