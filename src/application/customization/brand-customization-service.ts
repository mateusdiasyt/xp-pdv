...
export const defaultBrandCustomization = {
  ...
  businessDayStartsAt: "19:00",
  businessDayEndsAt: "01:00",
};
      ...
      try {
        ...
        return {
          customization: {
            ...
            businessTimezone: retriedCustomization.businessTimezone,
            businessDayStartsAt: retriedCustomization.businessDayStartsAt,
            businessDayEndsAt: retriedCustomization.businessDayEndsAt,
...
export async function updateBrandCustomizationRecord(input: FormData, actor: { id?: string; name: string }) {
  const parsed = updateBrandCustomizationSchema.parse({
    ...
    businessTimezone: input.get("businessTimezone"),
    businessDayStartsAt: input.get("businessDayStartsAt"),
    businessDayEndsAt: input.get("businessDayEndsAt"),
  ...
  try {
    ...
    updated = await upsertBrandCustomization({
      ...
      businessDayStartsAt: parsed.businessDayStartsAt,
      businessDayEndsAt: parsed.businessDayEndsAt,
  ...
  await createAuditLog({
    ...
    metadata: {
      ...
      businessTimezone: updated.businessTimezone,
      businessDayStartsAt: updated.businessDayStartsAt,
      businessDayEndsAt: updated.businessDayEndsAt,
